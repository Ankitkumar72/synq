...
import 'package:synq/features/timeline/presentation/pages/weekly_focus_screen.dart';
            ...
            Text(
              ...
              style: GoogleFonts.roboto(
                ...
                color: focusState.objective.isEmpty
                    ...
                    : Colors.black, // Lighter color if empty
                height: 1.4,
              ),
            ),
                  ...
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      border: focusState.priority == 'High Priority'
                          ? Border.all(
                              color: const Color(0xFF4B7BFF).withAlpha(80),
                              width: 1.5,
                            )
                          : null,
                    ),

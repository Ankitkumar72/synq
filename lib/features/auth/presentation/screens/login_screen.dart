    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        padding: const EdgeInsets.symmetric(
          vertical: 12,
          horizontal: 16,
        ), // Sames as official 40dp height usually, adjusted for padding
        decoration: BoxDecoration(
          color: Colors.white,
          borderRadius: BorderRadius.circular(
            24,
          ), // Rounded pill shape or 4px? Google uses both. Pill is better for this app.
          ...
          children: [
            ...
            Flexible(
              child: Text(
                ...
                style: const TextStyle(
                  fontFamily:
                      'Roboto', // Use Roboto if available, else standard
                  fontWeight: FontWeight.w500,
                  fontSize: 16,
